...
from expense_ai.finance import build_summary_for_range, render_summary
...
async def handle_month_summary_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await query.edit_message_text(render_summary(summary), reply_markup=month_nav_keyboard("summary_month", year, month))
